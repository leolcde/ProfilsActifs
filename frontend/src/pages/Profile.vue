...
import JebBadge from '../components/ui/JebBadge.vue'

const route = useRoute()
const profile = MOCK_PROFILES.find(p => p.id === route.params.id) ?? MOCK_PROFILES[0]
const isMyProfile = route.params.id === '1'
